...
### how to signin with the users::: ## Step-14: Execute Terraform Commands
```t
...
export AWS_SESSION_TOKEN=IQoJd
...
Error refreshing state: AccessDenied: Access Denied
	status code: 403, request id: A1FGCJSFAZNG3XHR, host id: d=
